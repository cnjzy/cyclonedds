 ...
 */
DDS_EXPORT  void*	RealtimeNetInit(RtNetInitParam initParam);
 ...
 */
DDS_EXPORT  int		RealtimeNetRead(void* pContext, unsigned int offset, void* pBuffer, unsigned int size);
 ...
 * @return			函数调用结果 1-成功 0-失败
 */
DDS_EXPORT  int		RealtimeNetWrite(void* pContext,unsigned int offset,void* pBuffer,unsigned int size);
 ...
 * @return	null
 */
DDS_EXPORT void  RealtimeNetFree(void* pContext);
